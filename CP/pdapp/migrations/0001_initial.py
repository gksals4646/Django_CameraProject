    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bodytype', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='pdapp.bodytype')),
                ('lenstype', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='pdapp.lenstype')),
            ],
        ),
        migrations.CreateModel(
            name='Type',
